...
EOF;
    ...
    public function add_component($recipe_component, $vce) {
		...
		$text_input_first = $vce->content->create_input($input,'Comment','Add A Comment');
		
		$text_input_seocond = $vce->content->create_input($input,'Comment','Add A Comment');
		
		$text_input_three = $vce->content->create_input($input,'Comment','Add A Comment');
		...
		$update_input = $vce->content->create_input($input,'Comment','Add A Comment');
				...
				<div class="comment-row-content arrow-box">
					...
					<div class="reply-form">
						<form id="add_comments" class="asynchronous-form" method="post" action="$vce->input_path" autocomplete="off">
							...
							$text_input
							<input type="submit" value="Save Comment">
							<button class="link-button reply-form-cancel">Cancel</button>
						</form>
					</div>
					<div class="update-form">
						<form class="asynchronous-form" method="post" action="$vce->input_path" autocomplete="off">
							<input type="hidden" name="dossier" value="{dossier-for-update}">
							$update_input
							<input type="submit" value="Update Comment"> <button class="link-button update-form-cancel">Cancel</button>
						</form>
					</div>
					<div class="comment-reply-delete">
						<button class="no-style link-inline reply-form-link">{$this->lang('Reply')}</button>
