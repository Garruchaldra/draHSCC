...
class Notifier extends Component {
	...
	public static function user_settings_as_content() {
		...
		foreach ($enabled_notifiertype as $notifier_name=>$notifier_path) {
			...
			<div class="notifier-type-title">' . $notifiertype[$notifier_name]->description . '</div>';
			...
			$notifiertype[$notifier_name]->notifier_content .= '<div class="notifier-type-item"><div class="notifier-type-input">' . $vce->content->input_element($input) . '</div><div class="notifier-type-text">All notifications of this type</div></div>';

			$notifiertype[$notifier_name]->notifier_content .= '<div class="notifier-type-options notifier-type-options-' . $selected . '">';

			$notifiertype[$notifier_name]->notifier_content .= '<div class="notifier-type-specific">Select specific notifications of this type</div>';
			...
			if (method_exists($notifiers[$each_type], 'notify')) {
				...
				if (!empty($options)) {
					...
					foreach ($notifiertype as $notifier_name=>$notifier_object) {
						...
						// 
						$notifiertype[$notifier_name]->notifier_content .= '<div class="notifier-type-component">' . $component_info['name'] . '</div>';
						...
						foreach ($options as  $option_name=>$option_text) {
							...
							$notifiertype[$notifier_name]->notifier_content .= '<div class="notifier-type-item"><div class="notifier-type-input">' . $vce->content->input_element($input) . '</div><div class="notifier-type-text">' . $option_text . '</div></div>';
...
EOF;
		...
		$content = $vce->content->accordion('Notifications Settings', $notifier_content, true, true);
