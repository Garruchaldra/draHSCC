			...
			if ($type == 'select') {
				...
				if (empty($content) && in_array($type, array('checkbox', 'radio'))) {
					...
					if ($input['type'] == 'checkbox' && isset($input['flags']['default'])) {
						...
						$content .= '<mainput type="' . $type . '"><input type="hidden" name="' . $input_name . '" value="' . $input['flags']['default'] . '"></mainput>';
					}
				...
				$content .= '<mainput type="' . $type . '"><input type="' . $type . '" options-group="' . $name . '"';
