...
EOF;
	...
	$insert = <<<EOF
	<label>
	<input type="hidden" name="organization" value="$user_info->organization">
	...
	<div class="label-error">Enter Organization</div>
	</div>
	</label>
EOF;
...
EOF;
	...
	<div class="label-text">
	<div class="label-message">Group
	</div>
	<div class="label-error">Enter your Group</div>
	</div>
	</label>
EOF;
...
EOF;
	...
	<div class="label-error">Select A group</div>
	</div>
	</label>
EOF;
