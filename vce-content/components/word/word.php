...
class Word extends MediaType {
	...
	public function display($each_component, $vce) {
    	...
    	$contents_for_download = '<p><div class="download-button"><a class="link-button download-button-word" href="' . $vce->site->media_link($fileinfo_for_download) . '"><p class="download-text">' . $each_component->title . '</p>Download this Word doc to your computer</a></div></p>';
