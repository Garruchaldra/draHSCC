$(document).ready(function() {
	...
	uploader.binder = function(eachUploader) {
		...
		var typelist = [];
		thisUploader.siblings('.media-types').each(function() {
			var eachmime = {};
		...
		var accept = [];
		thisUploader.siblings('.file-extensions').each(function() {
			...
			var upload = new tus.Upload(file, {
				...
				*/
				...
				onBeforeRequest: function(req) {
					...
					function () {
						console.log('error happened when counter is ' + counter);
						upload.start();
					}
					, restartTimeout);
					// console.log('sent ' + counter);
