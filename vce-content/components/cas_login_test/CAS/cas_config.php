...
$phpcas_path = BASEPATH .'/vce-content/components/cas_login';
//  $phpcas_path = '/var/www/ohscc/cc/vce-content/components/cas_login';

///////////////////////////////////////
// Basic Config of the phpCAS client //
///////////////////////////////////////

// Full Hostname of your CAS Server (using a constant because that is the most fool-proof way of identifying it so
// it can be edited by a configuration script
// secure.eclkcdev.cleverex.com
// define('CAS_HOST', 'secure.eclkc.ohs.acf.hhs.gov');
define('CAS_HOST', 'eclkc.ohs.acf.hhs.gov');
 
$cas_host = CAS_HOST;
//$cas_host = 'content.cleverex.com';
