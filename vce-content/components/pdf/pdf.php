	...
	public function display($each_component, $vce) {
		...
		if (!$prevent_inline_media) {
			...
			if ($display_inline) {
				...
				// create contents the complicated way
				// $contents = '<mamediapdf><div style="height:calc(100vw * .602);"><object data="' .  $vce->site->media_link($fileinfo) . '" type="application/pdf" style="width:100%;height:100%;"><embed src="' .  $vce->site->media_link($fileinfo) . '" type="application/pdf" /></embed></object></div></mamediapdf>';
				// $contents = '<mamediapdf><div style="height:calc(100vw * .602);"><embed src="' .  $vce->site->media_link($fileinfo) . '" type="application/pdf" style="width:100%;height:100%;"></embed></div></mamediapdf>';
